...
(define-theme-faces
  ...
  (font-lock-comment-delimiter-face     :FG "#FFFFFF" )
  ...
  ;; for racket-mode
  ;; (racket-keyword-argument-face         :FG "royal blue" )
  (racket-paren-face                    :FG "deep sky blue" )
  ;; (racket-selfeval-face                 :FG "royal blue" )

  ;; git merge
  (smerge-upper :FG "red")
  (smerge-lower :FG "dark olive green")
  (smerge-markers :FG "blue")
  (smerge-refined-added :FG "navy blue")
  (smerge-refined-removed :FG "magenta")
  ...
  ;; MODE-LINE
  ;; (mode-line                    :FG (divide-color "orange red" 2)
  ;;                               :BG  (divide-color "spring green" .7)
  ;;                               :U "green"  )
  ;; (mode-line-inactive           :FG "orange red"
  ;;                               :BG (divide-color "spring green" .7)
  ;;                               :U "gray13" )
  ;; (mode-line-buffer-id       :FG "black" ;; :H 120
  ;;                            )
