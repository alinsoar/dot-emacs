...
(let ((loads (get 'ghc-core 'custom-loads))) (if (member '"ghc-core" loads) nil (put 'ghc-core 'custom-loads (cons '"ghc-core" loads)) (put 'haskell 'custom-loads (cons 'ghc-core (get 'haskell 'custom-loads)))))
...
(fn OTHER-WINDOW)" t)
(let ((loads (get 'haskell-cabal 'custom-loads))) (if (member '"haskell-cabal" loads) nil (put 'haskell-cabal 'custom-loads (cons '"haskell-cabal" loads)) (put 'haskell 'custom-loads (cons 'haskell-cabal (get 'haskell 'custom-loads)))))
...
(let ((loads (get 'haskell-compile 'custom-loads))) (if (member '"haskell-compile" loads) nil (put 'haskell-compile 'custom-loads (cons '"haskell-compile" loads)) (put 'haskell 'custom-loads (cons 'haskell-compile (get 'haskell 'custom-loads)))))
...
(let ((loads (get 'haskell-completions 'custom-loads))) (if (member '"haskell-completions" loads) nil (put 'haskell-completions 'custom-loads (cons '"haskell-completions" loads)) (put 'haskell 'custom-loads (cons 'haskell-completions (get 'haskell 'custom-loads)))))
...
(let ((loads (get 'haskell 'custom-loads))) (if (member '"haskell-customize" loads) nil (put 'haskell 'custom-loads (cons '"haskell-customize" loads)) (put 'languages 'custom-loads (cons 'haskell (get 'languages 'custom-loads)))))
(let ((loads (get 'haskell-interactive 'custom-loads))) (if (member '"haskell-customize" loads) nil (put 'haskell-interactive 'custom-loads (cons '"haskell-customize" loads)) (put 'haskell 'custom-loads (cons 'haskell-interactive (get 'haskell 'custom-loads)))))
...
(let ((loads (get 'haskell-debug 'custom-loads))) (if (member '"haskell-debug" loads) nil (put 'haskell-debug 'custom-loads (cons '"haskell-debug" loads)) (put 'haskell 'custom-loads (cons 'haskell-debug (get 'haskell 'custom-loads)))))
...
(let ((loads (get 'haskell-decl-scan 'custom-loads))) (if (member '"haskell-decl-scan" loads) nil (put 'haskell-decl-scan 'custom-loads (cons '"haskell-decl-scan" loads)) (put 'haskell 'custom-loads (cons 'haskell-decl-scan (get 'haskell 'custom-loads)))))
...
(let ((loads (get 'haskell-doc 'custom-loads))) (if (member '"haskell-doc" loads) nil (put 'haskell-doc 'custom-loads (cons '"haskell-doc" loads)) (put 'haskell 'custom-loads (cons 'haskell-doc (get 'haskell 'custom-loads)))))
...
(let ((loads (get 'haskell-appearance 'custom-loads))) (if (member '"haskell-font-lock" loads) nil (put 'haskell-appearance 'custom-loads (cons '"haskell-font-lock" loads)) (put 'haskell 'custom-loads (cons 'haskell-appearance (get 'haskell 'custom-loads)))))
...
(let ((loads (get 'haskell-indent 'custom-loads))) (if (member '"haskell-indent" loads) nil (put 'haskell-indent 'custom-loads (cons '"haskell-indent" loads)) (put 'haskell 'custom-loads (cons 'haskell-indent (get 'haskell 'custom-loads)))))
...
(let ((loads (get 'haskell-indentation 'custom-loads))) (if (member '"haskell-indentation" loads) nil (put 'haskell-indentation 'custom-loads (cons '"haskell-indentation" loads)) (put 'haskell 'custom-loads (cons 'haskell-indentation (get 'haskell 'custom-loads)))))
...
(let ((loads (get 'inferior-haskell 'custom-loads))) (if (member '"inf-haskell" loads) nil (put 'inferior-haskell 'custom-loads (cons '"inf-haskell" loads)) (put 'haskell 'custom-loads (cons 'inferior-haskell (get 'haskell 'custom-loads)))))
